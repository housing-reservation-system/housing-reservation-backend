...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="message">
                You recently requested to reset your password for your account. Use the code below to proceed.
            </div>
            
            <div class="code-container">
                <div class="code-label">Password Reset Code</div>
                <div class="verification-code">{{ $resetCode }}</div>
                <div class="code-note">This code will expire in 60 minutes</div>
            </div>
